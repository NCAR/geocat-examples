...
for x in range(1, len(bins)):
    ...
    plt.scatter(masked_lon, masked_lat, label=label, s=sizes[x], color=colors[x], zorder=1)
...
label = "x >= " + str(bins[-1])
plt.scatter(masked_lon, masked_lat, label=label, s=sizes[-1], color=colors[-1], zorder=1)
