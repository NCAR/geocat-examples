...
This script illustrates the following concepts:
    - Exploring the Geoviews capabilities on Case 1 at the issue https://github.com/NCAR/GeoCAT-examples/issues/272.
    - Below concepts and source code are pasted directly from /Plots/Overlays/NCL_overlay_6.py of the following repository: https://github.com/NCAR/GeoCAT-examples

NCL_overlay_6.py concepts:
